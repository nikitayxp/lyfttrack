    ...
    >
      ...
      <View style={styles.card}>
        ...
        <View style={styles.searchRow}>
          ...
          <TextInput
            accessibilityLabel={t('accessibility.searchUsers', { defaultValue: 'Search users' })}
            value={query}
            ...
            return (
              <View key={result.id} style={styles.searchItem}>
                <TouchableOpacity
                  ...
                  accessibilityLabel={t('accessibility.viewUserProfile', { name: displayNameOf(result), defaultValue: 'View profile' })}
                >
                  {result.avatar_url ? (
                ...
                <TouchableOpacity
                  ...
                  accessibilityRole="button"
                  accessibilityLabel={relationLabel(relation)}
                >
                  {isSending ? (
            ...
            return (
              <View key={request.id} style={styles.requestItem}>
                <TouchableOpacity
                  ...
                  disabled={!profile?.id}
                  accessibilityRole="link"
                  accessibilityLabel={t('accessibility.viewUserProfile', { name: profile ? displayNameOf(profile) : fallbackName, defaultValue: 'View profile' })}
                >
                  {profile?.avatar_url ? (
            ...
            .map((friend) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  accessibilityRole="link"
                  accessibilityLabel={t('accessibility.viewUserProfile', { name: displayNameOf(friend.profile), defaultValue: 'View profile' })}
                >
